...
const CountsCard = ({ item, data }) => {
  // Safely retrieve the value and ensure it's a number
  const value = data && typeof data[item.key] === "number" ? data[item.key] : 0;
  ...
  return (
    <Card>
      <Left>
        ...
        <Value>
          {value.toFixed(2)} {/* Ensure the value is numeric before formatting */}
          <Unit>{item?.unit}</Unit>
